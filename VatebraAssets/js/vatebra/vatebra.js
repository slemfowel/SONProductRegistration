$(function () {
  'use strict';
  // page - settings.html  // showing 2nd level sub menu while hiding others
  ...
  $('#vatebraSidebarMenu').on('click', function (e) {
    e.preventDefault();
  ...
  if ($.fn.perfectScrollbar) {
    $('.vatebra-sidebar').perfectScrollbar({
  ...
  //     if(isRtl) {
  //       $('.vatebra-direction[value="rtl"]').prop('checked', true);
  //     } else {
  //       $('.vatebra-direction[value="ltr"]').prop('checked', true);
  //     }
  ...
  //       $('body').addClass('vatebra-sticky-header');
  ...
  //       $('body').addClass(sk);
  //       $('#headerSkin').attr('href',  '../css/vatebra.'+sk+'.css');
  ...
  //       $('body').addClass('vatebra-full-width');
  ...
  //     if($.cookie('sticky-sidebar') && $('.vatebra-sidebar').length) {
  //       $('body').addClass('vatebra-sticky-sidebar');
  ...
  $('body').on('click', '.vatebra-direction', function () {
    var val = $(this).val();
  ...
  $('body').on('click', '.sticky-header', function () {
    ...
    if (val === 'yes') {
      ...
      $('body').removeClass('vatebra-sticky-header');
    }
  });

  // toggles sidebar to sticky
  $('body').on('click', '.sticky-sidebar', function () {
    if ($('.vatebra-sidebar').length) {
      var val = $(this).val();
      if (val === 'yes') {
        ...
        $('body').removeClass('vatebra-sticky-sidebar');
      }
    } else {
  ...
  $('body').on('click', '.header-skin', function () {
    ...
    if (val !== 'default') {
      ...
      $('#headerSkin').attr('href', '../css/vatebra.' + val + '.css');
    } else {
  ...
  $('body').on('click', '.full-width', function () {
    ...
    if (val === 'yes') {
      ...
      $('body').removeClass('vatebra-full-width');
    }
  });
